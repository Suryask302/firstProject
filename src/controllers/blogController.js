...
const updateBlogs = async (req, res) => {
    ...
    try {
        ...
        if(isValid(title)) {
            ...
            // if(!Object.prototype.hasOwnProperty.call(updateBlogData, '$set')) {
            //     updateBlogData['$set'] = {}
            // }
            
            if (!updateBlogData.hasOwnProperty('$set')) {
                updateBlogData['$set'] = {}
            }
        ...
        if(tags) {
            ...
            if(!Object.prototype.hasOwnProperty.call(updateBlogData, '$addToSet')) {
                updateBlogData['$addToSet'] = {}
            }
